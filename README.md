# Adostigia — site vitrine d'architecture
...
5. **Sitemap** — remplacez `adostigia.com` par le domaine réel dans
...
laiton de la signalétique Adostigia. Tous les jetons sont dans `:root`
(`src/index.css`) :
...
#   a r c h i t e c t - a k o u b r i  
 