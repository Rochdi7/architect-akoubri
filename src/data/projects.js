...
export const projects = [
     ...
     of the walkthrough video. Program read from the rooms themselves.   */
  {
    ...
    video: `${M}/akoubri_adostigia-visite-virtuelle-bureaux.mp4`,
    videoPoster: `${M}/akoubri_adostigia-accueil-video-poster.webp`,
    videoCaption: "Parcours intérieur — circulation, salles de réunion et sanitaires",
    cover: `${M}/akoubri_adostigia-accueil-enseigne-relief-marbre-01.webp`,
    coverAlt:
    ...
    hover: `${M}/akoubri_adostigia-accueil-banque-monolithique-02.webp`,
    gallery: [
      img('akoubri_adostigia-accueil-enseigne-relief-marbre-01.webp',
        "Accueil Adostigia : enseigne en relief sur panneau de marbre sombre rétroéclairé, murs de pierre claire cannelée et fauteuils ronds",
        "Accueil — l'enseigne détachée du mur par une ligne de lumière"),
      img('akoubri_adostigia-accueil-banque-monolithique-02.webp',
      ...
      img('akoubri_adostigia-salon-accueil-enseigne-marbre-09.webp',
      ...
      img('akoubri_adostigia-accueil-banque-pierre-banquette-04.webp',
      ...
      img('akoubri_adostigia-circulation-lambris-bois-05.webp',
      ...
      img('akoubri_adostigia-accueil-depuis-entree-06.webp',
      ...
      img('akoubri_adostigia-cloison-vitree-bandes-sablees-07.webp',
      ...
      img('akoubri_adostigia-accueil-enseigne-fauteuils-08.webp',
      ...
      img('akoubri_adostigia-salle-reunion-plongee-12.webp',
        "Salle de réunion vue en plongée, table en marbre sombre et huit fauteuils",
        'Salle de réunion vue en plongée'),
      img('akoubri_adostigia-salle-reunion-suspension-globes-13.webp',
      ...
      img('akoubri_adostigia-bureau-direction-plan-noir-11.webp',
        "Bureau de direction : plan de travail noir, fauteuils clairs et grande fenêtre voilée",
        'Direction — plan noir et fenêtre voilée'),
      img('akoubri_adostigia-suspension-globes-panneau-bois-14.webp',
        "Suspension à globes de verre sur un panneau de bois encadré d'une corniche lumineuse",
        'Détail du luminaire'),
      img('akoubri_adostigia-ecran-projection-plafond-15.webp',
      ...
      img('akoubri_adostigia-salle-reunion-table-marbre-17.webp',
      ...
      img('akoubri_adostigia-bureau-direction-marbre-lustre-18.webp',
      ...
      img('akoubri_adostigia-bureau-direction-plongee-19.webp',
        "Bureau de direction en plongée, plan noir, bibliothèque éclairée et fauteuils clairs",
        'Bureau de direction en plongée'),
      img('akoubri_adostigia-bureau-direction-bibliotheque-marbre-20.webp',
      ...
      img('akoubri_adostigia-salle-reunion-double-table-21.webp',
        "Salle de réunion ouverte sur un bureau de direction, double table en marbre",
        'Réunion ouverte sur la direction'),
      img('akoubri_adostigia-salon-attente-canape-courbe-22.webp',
      ...
      img('akoubri_adostigia-poste-direction-plongee-10.webp',
     ...
     « Apt 36 — 54,42 m² » and apartments 47/48.                       */
  {
    ...
    gallery: [
      ...
      img('akoubri_le-sentier-chambre-18.webp',
        ...
        "Chambre type"),
      img('akoubri_le-sentier-toiture-piscine-crepuscule-lounge-06.webp',
        "Piscine de la toiture-terrasse au crépuscule : bains de soleil, parasols repliés, palmiers et éclairage immergé",
        "La piscine au crépuscule"),
      ...
      img('akoubri_le-sentier-chambre-salle-eau-attenante-14.webp',
        "Chambre et salle d'eau attenante : vasque en bois clair et miroir rétroéclairé vus depuis le lit",
        "Chambre — la salle d'eau attenante"),
      ...
      img('akoubri_le-sentier-chambre-meuble-tv-16.webp',
        "Chambre avec meuble TV suspendu en bois clair, rideaux voilés et parquet foncé",
        'Chambre — le meuble TV suspendu'),
      img('akoubri_le-sentier-chambre-tete-de-lit-capitonnee-17.webp',
      ...
      img('akoubri_le-sentier-toiture-piscine-fauteuils-rotin-08.webp',
        "Piscine de toiture en plein jour : fauteuils en rotin sous parasol au bord du bassin, terrasse en bois et palmiers",
        "Le bord de piscine en plein jour"),
      img('akoubri_le-sentier-toiture-bar-pergola-09.webp',
      ...
      img('akoubri_le-sentier-sejour-cuisine-ouverte-36.webp',
      ...
      img('akoubri_le-sentier-plan-cote-appartement-36.webp',
        "Plan coté de l'appartement 36 (54,42 m²) : chambre, salon, kitchenette, salle de bains et terrasse",
        "Plan de l'appartement 36"),
    ],
  },
     ...
     and video/card-03.mp4); they belong here.                           */
  {
    ...
    video: `${M}/akoubri_zahiya-facade-commerces-video.mp4`,
    videoPoster: `${M}/akoubri_zahiya-facade-commerces-video-poster.webp`,
    videoCaption: "La façade et son socle commercial",
    secondaryVideo: `${M}/akoubri_zahiya-sejour-livre-video.mp4`,
    secondaryVideoPoster: `${M}/akoubri_zahiya-sejour-livre-video-poster.webp`,
    secondaryVideoCaption: "Séjour livré — corniches lumineuses et menuiseries en noyer",
    cover: `${M}/akoubri_zahiya-entree-enseigne-crepuscule-01.webp`,
    coverAlt:
    ...
    hover: `${M}/akoubri_zahiya-facade-crepuscule-02.webp`,
    gallery: [
      img('akoubri_zahiya-entree-enseigne-crepuscule-01.webp',
        "Entrée de la résidence Zahiya au crépuscule : enseigne lumineuse sur bardage vertical sombre, façade en enduit minéral et arbre en avant-plan",
        "L'entrée et son enseigne"),
      img('akoubri_zahiya-facade-crepuscule-02.webp',
      ...
      img('akoubri_zahiya-chambre-ecran-penderie-04.webp',
      ...
      img('akoubri_zahiya-facade-angle-commerces-07.webp',
        "Angle de la résidence Zahiya : commerces vitrés en rez-de-chaussée, loggias et palmiers",
        "L'angle et ses commerces"),
      img('akoubri_zahiya-facade-laterale-crepuscule-08.webp',
        "Façade latérale de Zahiya au crépuscule : enduit minéral, loggias éclairées et arbres en pied d'immeuble",
        "La façade latérale au crépuscule"),
      img('akoubri_zahiya-sejour-livre-ecran-mural-34.webp',
      ...
      img('akoubri_zahiya-salle-a-manger-console-35.webp',
      ...
      img('akoubri_zahiya-salle-a-manger-table-ronde-09.webp',
      ...
      img('akoubri_zahiya-salle-a-manger-sejour-enfilade-10.webp',
      ...
      img('akoubri_zahiya-chambre-lin-suspensions-11.webp',
        "Chambre en tons clairs, lit en lin, suspensions basses et armoire en bois",
        'Chambre en tons clairs'),
      img('akoubri_zahiya-salle-de-bains-gres-beige-12.webp',
      ...
      img('akoubri_zahiya-chambre-chevet-lampe-13.webp',
        "Chambre claire : tête de lit cannelée, chevet en bois et lampe à abat-jour, porte voilée",
        'Chambre — chevet et lampe'),
      img('akoubri_zahiya-sejour-salle-a-manger-14.webp',
      ...
      img('akoubri_zahiya-facade-commerces-palmiers-15.webp',
        "Façade de la résidence Zahiya : socle commercial vitré, trois niveaux de logements à loggias et palmiers",
        'La façade et son socle commercial'),
      img('akoubri_zahiya-sejour-canape-angle-16.webp',
        "Séjour avec canapé d'angle, table basse ronde et enfilade vers le couloir",
        'Séjour et enfilade vers le couloir'),
      img('akoubri_zahiya-sejour-livre-console-17.webp',
        "Intérieur d'appartement livré, murs écrus et sol en grès cérame",
        'Appartement livré — murs écrus'),
      img('akoubri_zahiya-facade-enduit-sombre-loggias-18.webp',
        "Façade de Zahiya en enduit sombre avec loggias et végétation basse",
        'Enduit sombre et loggias'),
      img('akoubri_zahiya-facade-commerces-jour-19.webp',
        "Volume d'angle de Zahiya, jeu de retraits et de loggias",
        "Le volume d'angle"),
      img('akoubri_zahiya-facade-angle-contre-plongee-20.webp',
        "Façade de Zahiya vue en contre-plongée, menuiseries noires et enduit minéral",
        'La façade en contre-plongée'),
      img('akoubri_zahiya-facade-laterale-plantations-21.webp',
        "Façade latérale de Zahiya et plantations en pied d'immeuble",
        'Façade latérale et plantations'),
      img('akoubri_zahiya-entree-enseigne-arbre-22.webp',
        "Entrée de la résidence Zahiya : enseigne lumineuse sur bardage sombre, arbre et plantes en pot",
        "L'entrée de la résidence"),
      img('akoubri_zahiya-sejour-ecran-mural-23.webp',
      ...
      img('akoubri_zahiya-sejour-salle-a-manger-24.webp',
        "Séjour avec canapé d'angle beige, écran mural et table à manger dressée, enfilade vers le couloir",
        'Séjour et coin repas'),
      img('akoubri_zahiya-chambre-tons-sable-25.webp',
      ...
      img('akoubri_zahiya-sejour-coin-repas-26.webp',
        "Séjour et coin repas : canapé d'angle, écran mural, table dressée et baie voilée",
        "Séjour — le coin repas"),
      img('akoubri_zahiya-sejour-salle-a-manger-livre-27.webp',
        "Séjour et salle à manger livrés : table ronde en bois, suspension à tiges et diptyque encadré",
        'Séjour et salle à manger livrés'),
      img('akoubri_zahiya-sejour-depuis-entree-28.webp',
        "Salon vu depuis l'entrée, mur cannelé pleine hauteur et sol en marbre clair",
        "Salon vu depuis l'entrée"),
      img('akoubri_zahiya-cuisine-equipee-bois-29.webp',
        "Cuisine équipée : façades bois et blanches, plan noir, four encastré, lave-linge et porte vitrée sur la loggia",
        'Cuisine équipée'),
      img('akoubri_zahiya-chambre-tete-de-lit-cannelee-30.webp',
      ...
      img('akoubri_zahiya-hall-boites-aux-lettres-escalier-33.webp',
     ...
     visible as their own thread rather than merged into the bedrooms.   */
  {
    ...
    excerpt:
      "Une maison d'hôtes et ses bungalows, tenus par un vocabulaire de matières naturelles : liège mural, plafonds en bambou fendu, zellige, pierre sèche et vannerie.",
    body: [
    ...
    cover: `${M}/akoubri_maison-dhote-salon-marocain-coussins-rouges-13.webp`,
    coverAlt:
      "Salon marocain de la maison d'hôtes : murs de liège, plafond en bambou sur poutres, banquettes basses en U garnies de coussins rouges et lustre en verre coloré",
    hover: `${M}/akoubri_maison-dhote-chambre-bungalow-liege-arche-01.webp`,
    gallery: [
      img('akoubri_maison-dhote-chambre-armoire-bois-arche-07.webp',
      ...
      img('akoubri_maison-dhote-chambre-bungalow-liege-arche-01.webp',
      ...
      img('akoubri_maison-dhote-chambre-bungalow-armoire-bois-02.webp',
        "Chambre de bungalow avec penderie en bois cannelé, macramé mural et fauteuil en rotin",
        "Bungalow — rangements et coin salon"),
      img('akoubri_maison-dhote-chambre-miroir-lustre-11.webp',
        "Chambre en enduit clair : lustre en métal ajouré, miroir ovale en pied, fauteuil en rotin et macramé mural",
        "Chambre — le lustre et le miroir"),
      img('akoubri_maison-dhote-salle-de-bain-zellige-damier-05.webp',
      ...
      img('akoubri_maison-dhote-terrasse-couverte-banquette-bambou-08.webp',
      ...
      img('akoubri_maison-dhote-salle-de-bain-vasque-damier-19.webp',
        "Salle d'eau avec douche vitrée, zellige noir et blanc et sol en carreaux de ciment ocre",
        "Salle d'eau"),
      img('akoubri_maison-dhote-terrasse-toit-banquettes-10.webp',
      ...
      img('akoubri_maison-dhote-terrasse-pergola-pierre-seche-03.webp',
      ...
      img('akoubri_maison-dhote-chambre-penderie-bois-rotin-04.webp',
        "Chambre avec penderie en bois, macramé mural et chaise en rotin",
        'Chambre — penderie en bois et macramé'),
      img('akoubri_maison-dhote-chambre-porte-cintree-zellige-06.webp',
      ...
      img('akoubri_maison-dhote-terrasse-couverte-suspensions-09.webp',
      ...
      img('akoubri_maison-dhote-cuisine-marbre-suspensions-14.webp',
      ...
      img('akoubri_maison-dhote-chambre-cannage-liege-15.webp',
        "Chambre avec assise en rotin, plaid tissé et mur en liège",
        'Chambre — assise en rotin et mur de liège'),
      img('akoubri_maison-dhote-cuisine-marbre-porte-cintree-16.webp',
      ...
      img('akoubri_maison-dhote-salon-marocain-coussins-rouges-13.webp',
      ...
      img('akoubri_maison-dhote-chambre-lustre-macrame-17.webp',
      ...
      img('akoubri_maison-dhote-chambre-armoire-fauteuil-rotin-12.webp',
      ...
      img('akoubri_maison-dhote-chambre-claustra-fauteuil-rotin-18.webp',
  ...
  },
  {
    ...
    cover: `${M}/akoubri_villa-k-facade-crepuscule-01.webp`,
    coverAlt:
      "Villa Jumelée au crépuscule : maison jumelée en pierre claire, escalier hélicoïdal en bois visible à travers une baie vitrée toute hauteur",
    gallery: [
      img('akoubri_villa-k-facade-crepuscule-01.webp',
        "Villa Jumelée au crépuscule : maison jumelée en pierre claire, escalier hélicoïdal en bois visible à travers une baie vitrée toute hauteur",
        "L'escalier hélicoïdal derrière la faille vitrée"),
    ],
  },
  {
    slug: 'villa-jumelee-3',
    name: 'Villa Jumelée',
    subtitle: 'Maison individuelle',
    category: 'Villa',
    year: null,
    ...
    cover: `${M}/akoubri_villa-targa-facade-nuit-01.webp`,
    coverAlt:
      "Villa Jumelée au crépuscule : volumes cubiques décalés, tour d'angle en pierre sombre et jambages vitrés éclairés, jardin planté en pied de façade",
    gallery: [
      img('akoubri_villa-targa-facade-nuit-01.webp',
        "Villa Jumelée au crépuscule : volumes cubiques décalés, tour d'angle en pierre sombre et jambages vitrés éclairés, jardin planté en pied de façade",
...
export const showcase = [
  ...
  {
    src: `${M}/akoubri_zahiya-facade-angle-commerces-07.webp`,
    title: 'Façade, Zahiya',
    caption: 'Enduit gris taloché, balcons vitrés et rez-de-chaussée commercial sous les palmiers.',
    slug: 'zahiya',
  },
  {
    src: `${M}/akoubri_adostigia-accueil-enseigne-relief-marbre-01.webp`,
    title: 'Accueil, Adostigia',
    caption: 'Marbre sombre rétroéclairé et pierre claire cannelée.',
    slug: 'adostigia',
  },
  {
    src: `${M}/akoubri_maison-dhote-salon-marocain-coussins-rouges-13.webp`,
    title: "Salon marocain, Maison d'hôtes",
    caption: 'Murs de liège, laiton ajouré et tissages à rayures.',
    slug: 'maison-dhote',
  },
  {
    src: `${M}/akoubri_zahiya-sejour-livre-ecran-mural-34.webp`,
    title: 'Séjour, Zahiya',
    caption: "Enduit clair, corniches lumineuses et enfilade vers l'entrée.",
    slug: 'zahiya',
  },
  {
    src: `${M}/akoubri_farraj-administration-parking-09.webp`,
    title: 'Administration, Farraj',
    caption: 'Façade en enduit terre, carport solaire et stationnement bordé de palmiers.',
    slug: 'farraj',
  },
];
